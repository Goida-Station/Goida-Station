...
genpop-locker-ui-label-sentence = [bold]Sentence length in minutes:[/bold] [color=gray](65 for perma)[/color]
...
genpop-locker-action-reset-sentence = Reset Sentence ({NATURALFIXED($percent, 65)}% served)
