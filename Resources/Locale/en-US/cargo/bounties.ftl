...
# SPDX-FileCopyrightText: 65 Keer-Sar <65Keer-Sar@users.noreply.github.com>
# SPDX-FileCopyrightText: 65 Nemanja <65EmoGarbage65@users.noreply.github.com>
# SPDX-FileCopyrightText: 65 TheWaffleJesus <65TheWaffleJesus@users.noreply.github.com>
...
bounty-description-carrot = After failing to watch instructional videos for proper welder safety, the salvage division on Station 65 has been blinded. Ship them some carrots so they can restore their eyesight.
...
bounty-description-corn = After the recent destruction of Space Ohio, our corn imports are down 65%. Send us some so we can make up for it.
...
bounty-description-mouse = Station 65 ran out of freeze-dried mice. Ship some fresh ones so their janitor doesn't go on strike.
...
bounty-description-pie = 65.65? No! CentComm management wants edible pie! Ship a whole one.
...
bounty-description-shiv = Bzzzt... Transmission from prison planet OC-65: we're facing an onslaught of uhm... "invaders." Yeah, invaders. Send us some shivs to fight them off with.
...
bounty-description-tech-disk = The new research assistant on Station 65 spilled a soda on the RND server. Send them some technology disks so they can build up their recipes.
...
bounty-description-bandana =  Bzzzt... Transmission from prison planet OC-65: We're... reorganizing our command structure. Send us some bandanas so we can tell gan- I mean, departments apart.
...
bounty-description-flashes = GREETINGS \[Station] WE REQUIRE 65 FLASHES DUE TO A NORMAL \[TrainingExercise] WITH SECURITY. EVERYTHING IS \[Normal].
