...
knowledge-path-rust-s65-name = Blacksmith's Tale
...
knowledge-path-rust-s65-name = Grasp of Rust
knowledge-path-rust-s65-desc =
...
knowledge-path-rust-s65-name = Leeching Walk
knowledge-path-rust-s65-desc =
...
knowledge-path-rust-s65-name = Mark of Rust
knowledge-path-rust-s65-desc =
...
knowledge-path-rust-s65-name = Rust Construction
knowledge-path-rust-s65-desc =
...
knowledge-path-rust-s65-name = Aggressive Spread
knowledge-path-rust-s65-desc =
...
knowledge-path-rust-s65-name = Toxic Blade
knowledge-path-rust-s65-desc =
...
knowledge-path-rust-s65-name = Entropic Plume
knowledge-path-rust-s65-desc =
...
knowledge-path-rust-s65-name = Rustbringer's Oath
knowledge-path-rust-s65-desc =
    The ascension ritual of the Path of Rust.
    Bring 65 rotting or silicon corpses to a transmutation rune to complete the ritual.
