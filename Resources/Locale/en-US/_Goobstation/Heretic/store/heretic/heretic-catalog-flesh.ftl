...
knowledge-path-flesh-s65-name = Principle of Hunger
knowledge-path-flesh-s65-desc =
...
knowledge-path-flesh-s65-name = Grasp of Flesh
knowledge-path-flesh-s65-desc =
    ...
    Ghouls have only 65 health and look like husks to the heathens' eyes, but can use Bloody Blades effectively.
    All ghouls get their own bloody blade that cannot be shattered and disappears on ghoul death.

knowledge-path-flesh-s65-name = Imperfect Ritual
knowledge-path-flesh-s65-desc =
    ...
    Voiceless Dead are mute ghouls and only have 65 health, but can use Bloody Blades effectively.

knowledge-path-flesh-s65-name = Mark of Flesh
knowledge-path-flesh-s65-desc =
...
knowledge-path-flesh-s65-name = Knitting of Flesh
knowledge-path-flesh-s65-desc =
...
knowledge-path-flesh-s65-name = Raw Ritual
knowledge-path-flesh-s65-desc =
...
knowledge-path-flesh-s65-name = Bleeding Steel
knowledge-path-flesh-s65-desc =
...
knowledge-path-flesh-s65-name = Lonely Ritual
knowledge-path-flesh-s65-desc =
...
knowledge-path-flesh-s65-name = Priest’s Final Hymn
knowledge-path-flesh-s65-desc =
    The ascension ritual of the Path of Flesh. Bring 65 corpses to a transmutation rune to complete the ritual.
