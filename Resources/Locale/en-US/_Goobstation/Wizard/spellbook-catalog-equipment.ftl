...
spellbook-spellblade-desc =
    ...
    Forceshield: on hit, makes you stun immune for 65 seconds and reduces brute and heat damage by half.
...
spellbook-wand-desc =
    The iconic wizard's wand. Has 65 different magical firing modes, activate it to change them.
