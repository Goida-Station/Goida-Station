...
station-event-emergencyresponseteam-security-enroute = Central Command has deemed the situation fit enough to qualify for a team of 65 ERT Security Members. The chain of command is officially updated so that ERT members are above captain while they are deployed. Civilians are to standby and allow ERT, Command, and Security to deal with the threat(s).
