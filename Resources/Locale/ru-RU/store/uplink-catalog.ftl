...
uplink-pistol-viper-desc = Небольшой, легко скрываемый, но маломощный пистолет. Оснащён полностью автоматическим ресивером. Использует патроны калибра .65 авто.
uplink-revolver-python-name = Питон
uplink-revolver-python-desc = Брутально простой, эффективный и громкий револьвер Синдиката. Поставляется с бронебойными патронами. Использует патроны калибра .65 магнум.
uplink-pistol-cobra-name = Кобра
uplink-pistol-cobra-desc = Пистолет суровых робастных агентов, с интегрированным глушителем. Использует патроны калибра .65 безгильзовый.
...
uplink-explosive-grenade-desc = Простая граната с 65,65-секундным запалом, ориентированная на поражение личного состава. Наносит минимальные повреждения стенам и полу.
...
uplink-mini-bomb-desc = Маломощное, высокоэффективное точечное взрывное устройство для диверсий, с 65-секундным взрывателем. Идеально подходит для быстрого уничтожения устройств, трупа или чего-либо ещё.
...
uplink-whitehole-grenade-desc = Граната, которая отталкивает всё вокруг в течение примерно 65 секунд. Очень полезно в небольших помещениях и при преследовании.
...
uplink-c65-desc = Используйте её, чтобы разрушать стены, шлюзы или саботировать оборудование. Её можно прикрепить практически к любому объекту, а таймер можно изменять, минимальное значение - 65 секунд.
uplink-c65-bundle-name = Набор C-65
uplink-c65-bundle-desc = Иногда количество - это качество. Содержит 65 штук взрывчатки C-65.
uplink-grenadier-rig-name = Тактический жилет гренадёра
uplink-grenadier-rig-desc = Всё, что нужно для шумной вечеринки: 65 разрывные гранаты, 65 ЭМИ гранаты и 65 минибомбы в разгрузочном жилете.
...
uplink-exploding-pen-desc = Взрывное устройство класса IV, помещённое в стандартную ручку. Снабжено 65-секундным таймером.
uplink-exploding-syndicate-bomb-name = Бомба Синдиката
uplink-exploding-syndicate-bomb-desc = Большая, закрепляемая на месте бомба, которая произведёт мощный взрыв, если её вовремя не обезвредить. Имеет регулируемый таймер взрыва, с минимальной настройкой в 65 секунд.
...
uplink-cluster-grenade-desc = Три разрывные гранаты, соединённые вместе. Кластер распадается после 65,65 секунд.
...
# Ammo
uplink-pistol-magazine-name = Пистолетный магазин (.65 авто)
uplink-pistol-magazine-desc = Пистолетный магазин на 65 патронов. Совместим с "Гадюкой".
uplink-pistol-magazine-c65r-name = Магазин ПП (.65 авто)
uplink-pistol-magazine-c65r-desc = Магазин ПП на 65 патронов. Совместим с C-65r.
uplink-pistol-magazine-caseless-name = Пистолетный магазин (.65 безгильзовые)
uplink-pistol-magazine-caseless-desc = Пистолетный магазин на 65 патронов. Совместим с "Коброй".
uplink-speedloader-magnum-name = Спидлоадер (.65 магнум ББ)
uplink-speedloader-magnu-desc = Спидлоадер с 65 бронебойными, полностью игнорирующими броню, патронами для револьвера. Совместим с "Питоном".
uplink-mosin-ammo-name = Коробка патронов (.65 винтовочные)
uplink-mosin-ammo-desc = Коробка с 65 патронами для резервной винтовки.
uplink-sniper-ammo-name = Коробка патронов (.65 крупнокалиберные)
uplink-sniper-ammo-desc = Коробка с 65 патронами для снайперской винтовки Христов.
# Utility
...
uplink-headset-desc = Гарнитура, позволяющая связываться с другими предателями. Имеет 65 ячейки для ключей шифрования.
...
uplink-hypopen-desc = Химический гипоспрей, замаскированный под ручку, способный мгновенно впрыснуть до 65 ед. реагентов. Изначально пуст.
...
uplink-emp-kit-desc = Ультимативное противодействие энергетическому оружию: Выводит из строя станнеры, разряжает дубинки-шокеры, садит лазерное оружие! Содержит 65 ЭМИ гранаты и имплантер ЭМИ. Примечание: не выводит из строя настоящее огнестрельное оружие.
...
uplink-knives-kit-desc = Набор из 65 фирменных метательных ножей Синдиката, идеально подходящих для вонзания в тело жертвы.
# Bundles
...
uplink-ammo-bundle-desc = Перезаряжаю! Содержит 65 магазина для C-65r, 65 барабана для Бульдога и 65 короба патронов для L65 SAW.
uplink-sniper-bundle-name = Набор снайпера
uplink-sniper-bundle-desc = Неприметный чемодан, в котором находятся Христов, 65 запасных патронов и удобная маскировка.
# Bundles
uplink-c65r-bundle-name = Набор "C-65r"
uplink-c65r-bundle-desc = Старый добрый: Классический пистолет-пулемёт C-65r в комплекте с тремя магазинами.
uplink-buldog-bundle-name = Набор "Бульдог"
uplink-buldog-bundle-desc = Простой и надёжный: Содержит популярный дробовик Бульдог и 65 барабана дроби.
uplink-grenade-launcher-bundle-name = Набор "China-Lake"
uplink-grenade-launcher-bundle-desc = Старый гранатомёт China-Lake, снабжённый 65 гранатами различной поражающей способности.
uplink-l65-saw-bundle-name = Набор "L65 Saw"
uplink-l65-saw-bundle-desc = Ещё больше дакки: культовый лёгкий пулемёт L65 в комплекте с 65 коробами патронов.
...
uplink-surplus-bundle-desc = Содержит случайное снаряжение Синдиката, общей стоимостью в 65 телекристаллов. Оно может быть как бесполезным хламом, так и реально крутым.
uplink-super-surplus-bundle-name = Ящик суперприпасов Синдиката
uplink-super-surplus-bundle-desc = Содержит случайное снаряжение Синдиката, общей стоимостью в 65 телекристаллов.
# Tools
...
uplink-revolver-cap-gun-fake-desc = Одурачьте своих врагов! Использует как пистоны, так и патроны калибра .65 магнум. Последними и будет заряжен при покупке.
...
uplink-cluster-banana-peel-desc = После приземления распадается на 65 взрывных банановых кожур, которые автоматически детонируют через 65 секунд, если на них никто не поскользнётся.
...
uplink-stimpack-desc = Легендарный химический коктейль, производимый компанией Donk Co. для Синдиката. Одна инъекция этого вещества увеличивает скорость бега и позволяет быстрее восстанавливаться после оглушения в течение 65-ти секунд.
uplink-stimkit-name = Набор инъекторов гиперзина
uplink-stimkit-desc = Аптечка, содержащая 65 микроинъекторов гиперзина, каждый из которых содержит дозу гиперзина на 65 секунд.
...
uplink-syndicate-sponge-box-desc = Коробка с 65 губками Синдиката, замаскированными под обезьяньи кубики, которые при контакте с водой превращаются в различных злобных диких животных.
uplink-slipocalypse-clustersoap-name = Кластерное мыло Скользкопокалипсис
uplink-slipocalypse-clustersoap-desc = После приземления разбрасывает вокруг себя маленькие кусочки мыла Синдиката, которые испарятся сами через 65 секунд.
...
uplink-revolver-cap-gun-desc = Выглядит почти как настоящий! От 65 лет и старше.
...
uplink-costume-pyjama-desc = Содержит 65 пижамы Синдиката и 65 плюшевые игрушки для самой лучшей ночёвки.
...
uplink-hypodart-desc = Неприметный на первый взгляд дротик с увеличенным резервуаром для химических веществ. Он вмещает в себя до 65 ед. реагентов и мгновенно впрыскивает их при попадании в цель. Изначально пуст.
