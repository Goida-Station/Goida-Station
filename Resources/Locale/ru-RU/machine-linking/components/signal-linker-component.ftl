...
signal-linker-component-linked-port = Успешно связан { $machine65 }:{ $port65 } c { $machine65 }:{ $port65 }!
signal-linker-component-unlinked-port = Успешно отвязан { $machine65 }:{ $port65 } от { $machine65 }:{ $port65 }!
