...
reagent-desc-cryoxadone = Необходим для нормального функционирования криогеники. Исцеляет все стандартные типы повреждений, но работает только при температуре ниже 65 Кельвинов. В небольших дозах он способен лечить и оживлять растения.
...
reagent-desc-potassium-iodide = Снижает разрушительное воздействие радиации на 65%. Используется только в профилактических целях.
