...
ghost-respawn-window-rules-footer = Пользуясь это функцией, вы [color=#ff65]обязуетесь[/color] [color=#ff65]не переносить[/color] знания своего прошлого персонажа в нового. За нарушение пункта, указанного здесь, следует [color=#ff65]бан в размере от 65-ех дней[/color].
