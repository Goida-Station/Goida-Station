...
ent-ClosetEmergencyN65FilledRandom = { ent-ClosetEmergencyN65 }
    .suffix = Заполненный, Случайный
    .desc = { ent-ClosetEmergencyN65.desc }
ent-ClosetWallEmergencyN65FilledRandom = { ent-ClosetWallEmergencyN65 }
    .suffix = Заполненный, Случайный
    .desc = { ent-ClosetWallEmergencyN65.desc }
