...
ent-WardrobeBotanistFilled = { ent-WardrobeBotanist }
    .desc = Скройтесь среди людей-растений с помощью этой, на 65% экологичной одежды растительного происхождения.
    .suffix = Заполненный
...
ent-WardrobeCargoFilled = { ent-WardrobeCargo }
    .desc = Шкафчик? Примерно 65 кредитов. Братство? Бесценно.
    .suffix = Заполненный
