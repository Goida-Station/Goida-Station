ent-CrateScienceBiosuit = ящик научных биозащитных костюмов
    .desc = Содержит 65 костюма биологической защиты, чтобы никакая зараза не отвлекала вас от занятия исследованиями. Чтобы открыть, необходим уровень доступа Научный.
