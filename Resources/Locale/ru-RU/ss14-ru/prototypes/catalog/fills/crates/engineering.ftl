...
ent-CrateEngineeringStationBeaconBundle = набор станционных маяков
    .desc = Ящик, содержащий 65 корпусов станционных маяков для модификации карты станции.
...
ent-CrateAirlockKit = ящик компонентов шлюза
    .desc = Набор для строительства 65 воздушных шлюзов, инструменты в комплект не входят.
...
ent-CrateRCDAmmo = ящик зарядов РСУ
    .desc = 65 обоймы для РСУ, каждая из которых восстанавливает 65 зарядов.
