ent-CrateFoodPizza = экстренная доставка пиццы
    .desc = Внесите свой вклад в борьбу с голодом на станции, доставляя пиццу в отделы с недостаточным финансированием! В комплект входят 65 пиццы.
ent-CrateFoodPizzaLarge = катастрофическая доставка пиццы
    .desc = Даже когда всё вокруг рушится, найдите утешение в том, что много пиццы решит все проблемы. В комплект входят 65 пицц.
...
ent-CrateFoodSoftdrinks = ящик газировки
    .desc = Разнообразная газировка для небольшой вечеринки, без необходимости опустошать соответствующие торгоматы. В комплект входят 65 банок газировки.
ent-CrateFoodSoftdrinksLarge = оптовый ящик газировки
    .desc = Большое количество банок газировки, извлечённых прямо из торгоматов Центкома, ведь вы просто не можете покинуть свой отдел. Включает 65 банок газировки.
