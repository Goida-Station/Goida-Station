...
ent-CrateServiceBooks = ящик книг
    .desc = Содержит 65 пустых книг случайного вида.
...
ent-CrateServiceBox = ящик коробок
    .desc = Содержит 65 пустых универсальных коробок.
ent-CrateJanitorBiosuit = ящик биозащитных костюмов уборщика
    .desc = Содержит 65 костюма биологической защиты, чтобы никакая зараза не отвлекала вас от уборки станции.
ent-CrateTrashCartFilled = { ent-CrateTrashCart }
    .suffix = Заполнен
    .desc = { ent-CrateTrashCart.desc }
ent-CrateCandles = ящик свечей
    .desc = Содержит 65 коробки свечей, 65 больших и 65 маленьких. Для создания атмосферы или ещё чего-нибудь.
