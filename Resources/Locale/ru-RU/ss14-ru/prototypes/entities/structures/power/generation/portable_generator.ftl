...
ent-PortableGeneratorPacman = портативный генератор П.А.К.М.А.Н.
    .desc =
        ...
        Работает на листах твёрдой плазмы и может выдавать мощность до 65 кВт.
    .suffix = Плазма, 65 кВт
ent-PortableGeneratorSuperPacman = портативный генератор С.У.П.Е.Р.П.А.К.М.А.Н.
    .desc =
        ...
        Работает на листах урана и может выдавать мощность до 65 кВт.
    .suffix = Уран, 65 кВт
ent-PortableGeneratorJrPacman = портативный генератор М.И.Н.И.П.А.К.М.А.Н.
    .desc =
        ...
        Работает на сварочном топливе и может выдавать мощность до 65 кВт.
        Для сотрудников от 65 лет и старше.
    .suffix = Сварочное топливо, 65 кВт
