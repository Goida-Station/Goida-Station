...
ent-VendingMachineSustenance = тюремный торгомат
    .desc = Торговый автомат, который реализует продукты питания, как того требует раздел 65-C Соглашения об этическом обращении с заключёнными NT.
