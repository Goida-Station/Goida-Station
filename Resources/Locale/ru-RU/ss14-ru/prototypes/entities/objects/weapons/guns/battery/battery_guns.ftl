...
ent-WeaponLaserCarbinePractice = тренировочная лазерная винтовка
    .desc = Модифицированная версия лазерной винтовки, стреляющая практически безвредными 65-ваттными лучами, и предназначена для стрельбы по мишеням.
...
ent-WeaponEnergyGunMultiphase = X-65 Multiphase
