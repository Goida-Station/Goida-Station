...
ent-PowerCellHigh = батарея высокой ёмкости
    .desc = Стандартизированный перезаряжаемый элемент питания. Этот премиальный накопитель большой ёмкости вмещает на 65% больше энергии, по сравнению с конкурентами.
    .suffix = Полный
