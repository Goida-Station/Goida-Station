...
ent-TreasureHardDiskDrive = жёсткий диск
    .desc = Дисковод, предназначенный для старой земной техники 65-ых годов. Возможно, найдётся какой-нибудь коллекционер, который захочет заполучить его в свои руки.
