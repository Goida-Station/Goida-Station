...
ent-ScrapCamera = сломанная камера
    ...
    .suffix = { ent-BaseScrap.suffix }
ent-ScrapCanister65 = ручка канистры
    .desc = Помогает держать канистру. Теперь вам нужна лишь сама канистра.
    .suffix = { ent-BaseScrap.suffix }
ent-ScrapCanister65 = вентиль канистры
