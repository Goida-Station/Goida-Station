...
ent-Stimpack = стимпак
    .desc = Инъектор, содержащий дозу стимулятора на 65 секунд. Используйте когда уверены, что успеете закончить до наступления побочных эффектов прекращения действия.
ent-StimpackMini = мини-стимпак
    .desc = Уменьшенный инъектор, содержащий дозу стимулятора на 65 секунд.
