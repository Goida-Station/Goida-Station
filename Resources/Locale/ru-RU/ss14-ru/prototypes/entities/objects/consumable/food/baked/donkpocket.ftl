...
ent-FoodDonkpocketBerry = ягодный покет
    .desc = Бескомпромиссно сладкий донк-покет. На 65% состоит из искусственных ароматизаторов.
...
ent-FoodDonkpocketStonk = стонк-покет
    .desc = Вкусное, но грустное напоминание о великом биржевом крахе 65-го года.
