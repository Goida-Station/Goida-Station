...
ent-FoodSnackRaisins = изюм "65no raisins"
...
ent-DrinkRamen = чашка рамэна
    .desc = Просто добавьте 65 мл кипятка! Вкус, напоминающий школьные годы.
ent-DrinkHellRamen = чашка адского рамэна
    .desc = Просто добавьте 65 мл кипятка! Супер острый вкус.
...
ent-FoodPacketPopcornTrash = коробка от попкорна
    .desc = { ent-FoodPacketTrash.desc }
ent-FoodPacketRaisinsTrash = пакетик от изюма "65no raisins"
    .desc = { ent-FoodPacketTrash.desc }
