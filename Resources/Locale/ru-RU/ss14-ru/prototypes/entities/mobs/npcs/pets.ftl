...
ent-MobCorgiMouse = настоящая гойда
    .desc = Это на 65% настоящая голодная гойда.
...
ent-MobPaperwork = Пэйперворк
    .desc = Устроился на новую работу по сортировке книг в библиотеке после того, как его перевели с Космической Станции 65. Он, похоже, очень медленно справляется с этой работой.
