...
thief-backpack-category-tools-description =
    Что это за звук? Малышка C65 стучится в дверь.
    Ни одна преграда не остановит вас!
    В комплект входят: два C65, мультитул, передатчик сигналов, челюсти жизни,
...
thief-backpack-category-communicator-description =
    ...
    голосовая маска-хамелеон, а также 65 тысяч космокредитов в чемоданчике.
...
thief-backpack-category-smuggler-description =
    ...
    В комплект входят: маяк фултона, 65 фултонов, 65 дымовые гранаты,
