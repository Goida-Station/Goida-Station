knowledge-path-lock-s65-name = Секрет стюарда
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Захват замка
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Бремя хранителя ключей
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Знак блокировки
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Обряд консьержа
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Ловкость взломщика
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Открывающий клинок
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Последнее убежище смотрителя
knowledge-path-lock-s65-desc =
...
knowledge-path-lock-s65-name = Разблокировать лабиринт
knowledge-path-lock-s65-desc =
    Ритуал вознесения Пути Замка.
    Принесите 65 трупа без органов к руне трансмутации, чтобы завершить ритуал.
