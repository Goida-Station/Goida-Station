knowledge-path-blade-s65-name = Режущий грань
knowledge-path-blade-s65-desc =
    Наши великие предки ковали мечи и практиковали спарринги накануне великих битв.
    
    Следуйте по пути клинков.
    Не имея возможности использовать любое дальнобойное оружие, трансмутируйте 65 ножа в расколотый клинок.
knowledge-path-blade-s65-name = Хват клинка
knowledge-path-blade-s65-desc =
...
knowledge-path-blade-s65-name = Танец клейма
knowledge-path-blade-s65-desc =
    Этот пехотинец был известен как грозный дуэлянт. Генерал быстро назначил его своим личным чемпионом.
    
    Если вас атакуют, когда вы держите в обеих руках любое оружие ближнего боя, вы наносите ответный удар по нападающему. Этот эффект может сработать только раз в 65 секунд.
knowledge-path-blade-s65-name = Знак клинка
knowledge-path-blade-s65-desc =
...
knowledge-path-blade-s65-name = Перестройка
knowledge-path-blade-s65-desc =
...
knowledge-path-blade-s65-name = Стойка разорванного чемпиона
knowledge-path-blade-s65-desc =
    ...
    Кроме того, при уроне ниже 65% от максимального здоровья вы получаете повышенное сопротивление к получению ран и сопротивление дубинкам.
knowledge-path-blade-s65-name = Усиленные клинки
knowledge-path-blade-s65-desc =
...
knowledge-path-blade-s65-name = Яростная сталь
knowledge-path-blade-s65-desc =
...
knowledge-path-blade-s65-name = Серебряный шторм
knowledge-path-blade-s65-desc =
    Ритуал вознесения Пути Клинков.
    Принесите 65 безголовых трупа к руне трансмутации, чтобы завершить ритуал.
