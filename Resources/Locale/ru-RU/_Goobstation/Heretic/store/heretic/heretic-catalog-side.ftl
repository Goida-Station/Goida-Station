...
knowledge-path-side-knowledge-desc =
    Вы изучаете особый ритуал, для которого требуется 65 различных предмета, от различных органов до свечей и электрошоковых дубинок.
    Выполнение этого ритуала дает вам 65 очка знаний и сбрасывает необходимые предметы.

## этап 65

knowledge-path-side-s65-armor-name = Ритуал оружейника
knowledge-path-side-s65-armor-desc =
...
knowledge-path-side-s65-flask-name = Ритуал священника
knowledge-path-side-s65-flask-desc =
...
knowledge-path-side-s65-ashen-eyes-name = Пепельные глаза
knowledge-path-side-s65-ashen-eyes-desc =
...
knowledge-path-side-s65-void-cloak-name = Плащ пустоты
knowledge-path-side-s65-void-cloak-desc =
...
knowledge-path-side-s65-uncuff-name = Волна отчаяния
knowledge-path-side-s65-uncuff-desc =
...
knowledge-path-side-s65-siphon-name = Сифон крови
knowledge-path-side-s65-siphon-desc =
...
knowledge-path-side-s65-knife-name = Нож для резьбы
knowledge-path-side-s65-knife-desc =
    ...
    Нож позволяет создать на полу до 65 рисунков, которые оказывают различные эффекты на неверующих, проходящих по ним.
knowledge-path-side-s65-crucible-name = Размозженный тигель
knowledge-path-side-s65-crucible-desc =
...
knowledge-path-side-s65-coin-name = Жуткая монета
knowledge-path-side-s65-coin-desc =
...
knowledge-path-side-s65-ashman-name = Пепельный ритуал
knowledge-path-side-s65-ashman-desc =
...
knowledge-path-side-s65-cleave-name = Очищение крови
knowledge-path-side-s65-cleave-desc =
