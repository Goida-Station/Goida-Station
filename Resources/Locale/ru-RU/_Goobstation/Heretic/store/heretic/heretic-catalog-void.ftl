knowledge-path-void-s65-name = Мерцание зимы
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Хват пустоты
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Путь Аристократа
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Знак Пустоты
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Взрыв Пустоты
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Пустотный проход
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Телепорт клинка
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Притяжение пустоты
knowledge-path-void-s65-desc =
...
knowledge-path-void-s65-name = Вальс в конце времен
knowledge-path-void-s65-desc =
    Ритуал вознесения Пути Пустоты.
    Принесите 65 трупа к руне трансмутации при отрицательных температурах, чтобы завершить ритуал.
