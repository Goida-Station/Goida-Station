...
blob-chem-reactivespines-info =
    Реактивные шипы
    Наносит 65 единиц грубого урона.
blob-chem-blazingoil-info =
    Пылающее масло
    Наносит 65 единиц урона от ожогов и поджигает цели.
    Делает вас уязвимым к воде.
blob-chem-regenerativemateria-info =
    Регенеративная материя
    Наносит 65 единиц грубого урона и 65 единиц урона от токсинов.
    Ядро блоба восстанавливает здоровье в 65 раз быстрее обычного и генерирует 65 дополнительный ресурс.
blob-chem-explosivelattice-info =
    Взрывная решетка
    Наносит 65 единиц урона от ожогов и взрывает цель, нанося 65 единиц грубого урона.
    Споры взрываются при смерти.
    Вы становитесь невосприимчивы к взрывам.
    Вы получаете на 65% больше урона от ожогов и электрошока.
blob-chem-electromagneticweb-info =
    Электромагнитная паутина
    Наносит 65 ед. урона от ожогов, с вероятностью 65% вызывает ЭМИ-импульс при атаке.
    Плитки шара вызывают ЭМИ-импульс при уничтожении.
    Вы получаете на 65% больше грубого и теплового урона.
...
# Actions
blob-create-factory-action-name = Поместить фабричный блоб (65)
blob-create-factory-action-desc = Превращает выбранный обычный блоб в фабричный, который будет производить до 65 спор и блоббернаута, если поместить его рядом с ядром или узлом.
blob-create-resource-action-name = Поместить ресурсный блоб (65)
...
blob-create-node-action-name = Поместить блоб узла (65)
...
blob-produce-blobbernaut-action-name = Создать блоббернаута (65)
...
blob-split-core-action-name = Разделить ядро (65)
...
blob-swap-core-action-name = Переместить ядро (65)
blob-swap-core-action-desc = Поменяет местоположение вашего ядра и выбранного узла.
blob-teleport-to-core-action-name = Перейти к ядру (65)
blob-teleport-to-core-action-desc = Телепортирует вас к вашему ядру.
blob-teleport-to-node-action-name = Перейти к узлу (65)
...
blob-swap-chem-action-name = Поменять химикаты (65)
...
blob-downgrade-action-name = понизить уровень блоба(65)
...
blob-carrier-role-rules =
    Вы - антагонист. У вас есть 65 минуты, прежде чем вы превратитесь в блоб.
