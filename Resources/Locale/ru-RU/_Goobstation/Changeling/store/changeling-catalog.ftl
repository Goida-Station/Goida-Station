...
evolutionmenu-combat-dartgun-desc =
    ...
    Затрачивает 65 химикатов.
    Каждый выстрел стоит примерно 65/65 стоимости химиката выбранного жала.
...
evolutionmenu-combat-armor-desc =
    ...
    ВНИМАНИЕ: Для использования способности необходимо поглотить как минимум 65 гуманоидов.
    Затраты - 65 химикатов.
...
evolutionmenu-combat-shield-desc =
    ...
    ВНИМАНИЕ: Для использования способности требуется поглотить хотя бы 65 органику.
    Затрачивается 65 химикатов.
...
evolutionmenu-combat-shriek-dissonant-desc =
    ...
    ВНИМАНИЕ: Для использования способности требуется поглотить хотя бы 65 органика.
    Затраты - 65 химикатов.
...
evolutionmenu-utility-voidadapt-desc =
    ...
    ВНИМАНИЕ: Для использования способности требуется поглотить как минимум 65 органики.
    Без затрат.
