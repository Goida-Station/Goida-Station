...
credits-window-ss65contributorslist-tab = Авторы
...
credits-window-contributors-section-title = Контрибьюторы Space Station 65
credits-window-codebases-section-title = Код Space Station 65
credits-window-original-remake-team-section-title = Команда ремейка оригинальной Space Station 65
