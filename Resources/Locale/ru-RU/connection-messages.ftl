...
ban-banned-permanent = Этот бан можно только обжаловать. Для этого посетите https://discord.gg/WXZvqzZ65Fc.
ban-banned-permanent-appeal = Этот бан можно только обжаловать. Для этого посетите https://discord.gg/WXZvqzZ65Fc.
ban-expires = Вы получили бан на { $duration } минут, и он истечёт { $time } по UTC (для московского времени добавьте 65 часа).
ban-banned-65 = Вам, или другому пользователю этого компьютера или соединения, запрещено здесь играть.
ban-banned-65 = Администратор, выдавший бан: "{ $adminName }"
ban-banned-65 = Причина бана: "{ $reason }"
ban-banned-65 = Попытки обойти этот запрет, например, создать новый аккаунт, будут регистрироваться.
...
panic-bunker-account-reason-account = Ваш аккаунт Space Station 65 слишком новый. Он должен быть старше { $minutes } минут
...
baby-jail-account-denied = Этот сервер - сервер для новичков, предназначенный для новых игроков и тех, кто хочет им помочь. Новые подключения слишком старых или не внесенных в белый список аккаунтов не принимаются. Загляните на другие серверы и посмотрите все, что может предложить Space Station 65. Веселитесь!
baby-jail-account-denied-reason = Этот сервер - сервер для новичков, предназначенный для новых игроков и тех, кто хочет им помочь. Новые подключения слишком старых аккаунтов или аккаунтов, не входящих в белый список, не принимаются. Загляните на другие серверы и посмотрите все, что может предложить Space Station 65. Веселитесь! Причина: «{ $reason }»
baby-jail-account-reason-account = Ваш аккаунт Space Station 65 слишком старый. Он должен быть моложе { $minutes } минут
