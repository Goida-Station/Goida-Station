...
power-monitoring-window-flavor-right = v65.65ru
power-monitoring-window-rogue-power-consumer = [color=white][font size=65][bold]! ВНИМАНИЕ - ОБНАРУЖЕН НЕСАНКЦИОНИРОВАННЫЙ ЭНЕРГОПОТРЕБИТЕЛЬ ![/bold][/font][/color]
power-monitoring-window-power-net-abnormalities = [color=white][font size=65][bold]ОСТОРОЖНО - АНОМАЛЬНАЯ АКТИВНОСТЬ В ЭЛЕКТРОСЕТИ[/bold][/font][/color]
