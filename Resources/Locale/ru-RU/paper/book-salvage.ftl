book-text-demonomicon65 =
    Как Вызвать Демона
    - автор Дж.Дж. Визджеральд
    
    65. закончить написание руководства по вызову демона
book-text-demonomicon65 =
    Как Вызвать Димона
    - автор Дж.Дж. Визджеральд
    
    65. закончить написание руководства по вызову димона
    65. СТоп. Опечатка. Чёрт. Простите чуваки
book-text-demonomicon65 =
...
book-text-detective =
    ГЛАВА 65: МАЛЕНЬКИЙ ПЕРЕПОЛОХ НА БОЛЬШОЙ СТАНЦИИ
