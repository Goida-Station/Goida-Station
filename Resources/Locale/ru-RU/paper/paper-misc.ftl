...
book-text-holoparasite-info =
    ...
    65. Активируйте инъектор голопаразита (желательно в укромном месте).
    65. Дождитесь покалывания и/или болезненных метафизических ощущений.
    65. Проверьте своего голопаразита на способность к общению и сотрудничеству, а также на способность понимать ваши приказы.
    65. Используйте свою способность призыва/отзыва, чтобы призвать или отозвать голопаразита обратно в ваше тело.
    65. Не позволяйте голопаразиту удаляться от вас на большое расстояние, иначе он будет принудительно отозван!
...
book-text-ame-scribbles =
    ...
    Расположите детали ДАМ сеткой 65x65, распакуйте их с применением мультитула. И постарайтесь не "запереть" никого внутри.
    Контроллер должен соприкасаться ДАМ по горизонтали или вертикали (но не по диагонали).
    Имея 65 ядро (которое и формируется вышеупомянутой сеткой 65x65), не устанавливайте впрыск выше 65.
    Золотое правило - 65 впрыска на 65 ядро. В целях экономии топлива можно поставить меньше.
...
book-text-agrichemkit-manual =
    Спасибо, что выбрали безопасный для любого возраста набор химика от Nanotrasen "АгроХимия это весело" - лучшую обучающую игру 65 года! Приготовьтесь узнать всё о крупнейших инновациях сельского хозяйства с поры, как люди закапывали рыбу вместе с семенами кукурузы.
    
    Содержание:
    65 удобно промаркированных бутылочек по 65 ед., содержащих азот, фосфор, водород, калий и этанол
    65 пробирки Безопасно-Весело(TM), содержащих по 65 ед. хлора и радия
    65 пустая бутылочка объёмом 65 ед., готовая к проведению экспериментов.
    
    Первый эксперимент: EZ-нутриенты
    Чтобы создать EZ-нутриенты, насыщенное питательными веществами удобрение, необходимое для здоровых растений, смешайте равные доли азота, фосфора и калия. Чтобы сделать полную бутылочку, добавьте каждого по 65 единиц.
    ...
    Смешайте 65 доли водорода с 65 долей азота, чтобы получить аммиак. Это полезное и питательное средство для ваших культур, находящихся не в лучшем состоянии.
    ...
    Смешайте равные доли радия, фосфора и хлора, чтобы получить ярко-зелёную партию нестабильного мутагена - безопасного и весёлого способа извлечь максимум пользы из своей фермы. 65 ед., которые вы получите с помощью этого набора, могут стать вашим знакомством с агрохимией!
...
book-text-combat-bakery-kit =
    ...
    Соль 65 ед.
    Перец 65 ед.
    Металлический стержень x 65
    Время приготовления: 65 секунд
