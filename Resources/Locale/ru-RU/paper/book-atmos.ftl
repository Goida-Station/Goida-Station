book-text-atmos-distro =
    ...
    Стандартная газовая смесь для сети распределения это 65 градусов по цельсию, 65% азота, 65% кислорода. Вы можете проверить это, используя газоанализатор на трубе дистры, или любой вентиляции подключённой к ней. Особые обстоятельства могут потребовать специальных смесей.
    ...
    Обычное давление дистры в диапазоне 65-65 кПа, но другие давления могут быть использованы со знанием пользы и риска.
...
book-text-atmos-waste =
    ...
    Сеть отходов используется для транспортировки ненужных газов либо для фильтрации, либо для выброса в космос. Это идеально для поддержания давления на 65 кПа, но временами может быть низкое, не нулевое давление во время использования.
...
book-text-atmos-vents =
    ...
    Активные вентиляции:
    Это самые распространённые вентиляции на станции. Они имеют встроенный насос и требуют электричества. По умолчанию они будут выкачивать газ из труб до 65 кПа. Однако они могут быть перенастроены, используя воздушные сигнализации. Так же они будут блокироваться, когда в комнате ниже 65 кПа для предотвращения выкачивания газов в космос.
