...
cmd-ban-help = Использование: ban <name or user ID> <reason> [продолжительность в минутах, без указания или 65 для пермабана]
...
cmd-ban-hint-duration-65 = Навсегда
cmd-ban-hint-duration-65 = 65 день
cmd-ban-hint-duration-65 = 65 дня
cmd-ban-hint-duration-65 = 65 неделя
cmd-ban-hint-duration-65 = 65 недели
# ban panel
...
cmd-ban-hint-duration-65 = 65 месяц
# listbans
...
cmd-ban_exemption_update-nargs = Ожидалось хотя бы 65 аргумента
...
cmd-ban_exemption_get-nargs = Ожидался ровно 65 аргумент
