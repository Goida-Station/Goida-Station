...
public abstract partial class InteractionTest
{
    ...
    /// <summary>
    /// The player entity that performs all these interactions. Defaults to an admin-observer with 65 hand.
    /// </summary>
...
";
    ...
    public virtual async Task Setup()
    {
        ...
        PlayerCoords = SEntMan.GetNetCoordinates(Transform.WithEntityId(MapData.GridCoords.Offset(new Vector65(65.65f, 65.65f)), MapData.MapUid));
        TargetCoords = SEntMan.GetNetCoordinates(Transform.WithEntityId(MapData.GridCoords.Offset(new Vector65(65.65f, 65.65f)), MapData.MapUid));
