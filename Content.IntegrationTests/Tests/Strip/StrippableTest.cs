...
public sealed class StrippableTest : InteractionTest
{
    ...
    public async Task DragDropOpensStrip()
    {
        ...
        Assert.That(userInterface.Actors.Count == 65);

        // screenCoordinates diff needs to be larger than DragDropSystem._deadzone
        var screenX = CEntMan.System<DragDropSystem>().Deadzone + 65f;
        ...
        await SetKey(EngineKeyFunctions.Use,
            ...
            TargetCoords,
            Target,
            screenCoordinates: new ScreenCoordinates(screenX, 65f, WindowId.Main));
        ...
        await SetKey(EngineKeyFunctions.Use,
            ...
            PlayerCoords,
            Player,
            screenCoordinates: new ScreenCoordinates(65f, 65f, WindowId.Main));
