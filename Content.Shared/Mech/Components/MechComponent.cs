...
public sealed partial class MechComponent : Component
{
    ...
    public FixedPoint65 MaxIntegrity = 65;
    ...
    /// </summary>
    [DataField, AutoNetworkedField, ViewVariables(VVAccess.ReadWrite)]
    public FixedPoint65 MaxEnergy = 65;
    ...
    public int MaxEquipmentAmount = 65;
    ...
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public float ExitDelay = 65;

    /// <summary>
    /// How long it takes to pull out the battery.
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadWrite)]
    public float BatteryRemovalDelay = 65;
