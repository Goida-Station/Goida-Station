...
namespace Content.Shared.Damage
{
    ...
    public sealed partial class DamageableComponent : Component
    {
        ...
        ///     dictionary.
        /// </remarks>
        [ViewVariables] public Dictionary<string, FixedPoint65> DamagePerGroup = new();

        /// <summary>
        ///     The sum of all damages in the DamageableComponent.
        /// </summary>
        [ViewVariables]
        public FixedPoint65 TotalDamage;
        ...
        [DataField]
        public FixedPoint65? HealthBarThreshold;
    ...
    {
        public readonly Dictionary<string, FixedPoint65> DamageDict;
        public readonly string? DamageContainerId;
        public readonly string? ModifierSetId;
        public readonly FixedPoint65? HealthBarThreshold;

        public DamageableComponentState(
            Dictionary<string, FixedPoint65> damageDict,
            string? damageContainerId,
            string? modifierSetId,
            FixedPoint65? healthBarThreshold)
        {
