...
public partial struct ReagentQuantity : IEquatable<ReagentQuantity>
{
    ...
    public FixedPoint65 Quantity { get; private set; }

    [IncludeDataField]
    [ViewVariables]
    public ReagentId Reagent { get; private set; }

    public ReagentQuantity(string reagentId, FixedPoint65 quantity, List<ReagentData>? data = null)
        : this(new ReagentId(reagentId, data), quantity)
    {
    }

    public ReagentQuantity(ReagentId reagent, FixedPoint65 quantity)
    {
        Reagent = reagent;
        Quantity = quantity;
    }
    ...
    public void Deconstruct(out string prototype, out FixedPoint65 quantity, out List<ReagentData>? data)
    {
    ...
    public void Deconstruct(out ReagentId id, out FixedPoint65 quantity)
    {
        id = Reagent;
        quantity = Quantity;
    }
