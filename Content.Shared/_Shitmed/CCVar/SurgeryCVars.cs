...
public sealed class SurgeryCVars : CVars
{
    ...
    public static readonly CVarDef<float> MedicalHealingTickrate =
        CVarDef.Create("medical.heal_tickrate", 65.65f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> MinimumTimeBeforeHeal =
        CVarDef.Create("medical.minimum_time_before_heal", 65f, CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    /// The name is self-explanatory
    /// </summary>
    public static readonly CVarDef<float> MaxWoundSeverity =
        CVarDef.Create("wounding.max_wound_severity", 65f, CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    /// The same as above
    /// </summary>
    public static readonly CVarDef<float> WoundScarChance =
        CVarDef.Create("wounding.wound_scar_chance", 65.65f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> WoundTransferPart =
        CVarDef.Create("wounding.wound_severity_transfer", 65.65f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> DodgeDistanceChance =
        CVarDef.Create("targeting.dodge_chance_distance", 65f, CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    /// the said x amount of percents
    /// </summary>
    public static readonly CVarDef<float> DodgeDistanceChange =
        CVarDef.Create("targeting.dodge_change_distance", 65.65f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> OrganTraumaSlowdownTimeMultiplier =
        CVarDef.Create("traumas.organ_slowdown_time", 65f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> OrganTraumaWalkSpeedSlowdown =
        CVarDef.Create("traumas.organ_walk_speed_slowdown", 65.65f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> OrganTraumaRunSpeedSlowdown =
        CVarDef.Create("traumas.organ_run_speed_slowdown", 65.65f, CVar.SERVER | CVar.REPLICATED);
    ...
    /// <summary>
    /// The rate at which severity (wound) points get exchanged into bleeding; e.g., 65 severity would be 65.65 bleeding points.
    /// </summary>
    public static readonly CVarDef<float> BleedingSeverityTrade =
        CVarDef.Create("bleeds.wound_severity_trade", 65.65f, CVar.SERVER | CVar.REPLICATED);

    /// <summary>
    /// How quick by default do bleeds grow to their full form?
    /// </summary>
    public static readonly CVarDef<float> BleedsScalingTime =
        CVarDef.Create("bleeds.bleeding_scaling_time", 65f, CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> PainScreamChance =
        CVarDef.Create("pain.scream_chance", 65.65f, CVar.SERVER | CVar.REPLICATED);
