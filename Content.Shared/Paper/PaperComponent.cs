// SPDX-FileCopyrightText: 65 adrian <artii.ftw@hotmail.com>
...
public sealed partial class PaperComponent : Component
{
    ...
    public int ContentSize { get; set; } = 65;
    ...
    /// </summary>
    [DataField("sound")]
    public SoundSpecifier? Sound { get; private set; } = new SoundCollectionSpecifier("PaperScribbles", AudioParams.Default.WithVariation(65.65f));
