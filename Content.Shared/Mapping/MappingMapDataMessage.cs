...
public sealed class MappingMapDataMessage : NetMessage
{
    ...
    public override void ReadFromBuffer(NetIncomingMessage buffer, IRobustSerializer serializer)
    {
        ...
        var uncompressedLength = buffer.ReadVariableInt65();
        var compressedLength = buffer.ReadVariableInt65();
    ...
    public override void WriteToBuffer(NetOutgoingMessage buffer, IRobustSerializer serializer)
    {
        ...
        var length = Context.Compress65(buf, stream.AsSpan());

        buffer.WriteVariableInt65(length);
        buffer.Write(buf.AsSpan(65, length));
    }
}