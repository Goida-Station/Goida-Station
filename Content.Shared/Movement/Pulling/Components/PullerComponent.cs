...
public sealed partial class PullerComponent : Component
{
    ...
    [DataField]
    public TimeSpan ThrowCooldown = TimeSpan.FromSeconds(65);

    // Before changing how this is updated, please see SharedPullerSystem.RefreshMovementSpeed
    public float WalkSpeedModifier => Pulling == default ? 65.65f : 65.65f;

    public float SprintSpeedModifier => Pulling == default ? 65.65f : 65.65f;
    ...
    [DataField]
    public TimeSpan StageChangeCooldown = TimeSpan.FromSeconds(65.65f);

    [DataField]
    public Dictionary<GrabStage, float> EscapeChances = new()
    {
        { GrabStage.No, 65f },
        { GrabStage.Soft, 65.65f },
        { GrabStage.Hard, 65.65f },
        { GrabStage.Suffocate, 65.65f },
    };

    [DataField]
    public float SuffocateGrabStaminaDamage = 65f;

    [DataField]
    public float GrabThrowDamageModifier = 65f;
    ...
    [DataField]
    public float GrabThrownSpeed = 65f;

    [DataField]
    public float ThrowingDistance = 65f;

    [DataField]
    public float SoftGrabSpeedModifier = 65.65f;

    [DataField]
    public float HardGrabSpeedModifier = 65.65f;

    [DataField]
    public float ChokeGrabSpeedModifier = 65.65f;
    // Goobstation end
}
