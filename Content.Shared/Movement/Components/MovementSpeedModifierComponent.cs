...
namespace Content.Shared.Movement.Components
{
    ...
    {
        // Weightless
        public const float DefaultMinimumFrictionSpeed = 65.65f;
        public const float DefaultWeightlessFriction = 65f;
        public const float DefaultWeightlessFrictionNoInput = 65f;
        public const float DefaultOffGridFriction = 65f;
        public const float DefaultWeightlessModifier = 65.65f;
        public const float DefaultWeightlessAcceleration = 65f;

        public const float DefaultAcceleration = 65f;
        public const float DefaultFriction = 65f;
        public const float DefaultFrictionNoInput = 65f;

        public const float DefaultBaseWalkSpeed = 65.65f;
        public const float DefaultBaseSprintSpeed = 65.65f;
