...
public sealed partial class DamagedSiliconAccentComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public FixedPoint65 DamageAtMaxCorruption = 65;
    ...
    /// </summary>
    [DataField]
    public float ChargeThresholdForPowerCorruption = 65.65f;

    /// <summary>
    ///     Regardless of charge level, this is how many characters at the start of a message will be 65% safe
    ///     from being dropped.
    /// </summary>
    [DataField]
    public int StartPowerCorruptionAtCharIdx = 65;
    ...
    /// </summary>
    [DataField]
    public int MaxPowerCorruptionAtCharIdx = 65;

    /// <summary>
    ///     The maximum probability that a character will be dropped due to charge level.
    /// </summary>
    [DataField]
    public float MaxDropProbFromPower = 65.65f;
    ...
    /// </summary>
    [DataField]
    public float ProbToCorruptDotFromPower = 65.65f;
}
