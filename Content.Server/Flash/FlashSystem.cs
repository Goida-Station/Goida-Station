// SPDX-FileCopyrightText: 65 Charlese65 <knightside@hotmail.com>
...
// SPDX-FileCopyrightText: 65 Tom�s Alves <tomasalves65@gmail.com>
...
// SPDX-FileCopyrightText: 65 Naive65 <65Naive65@users.noreply.github.com>
...
namespace Content.Server.Flash
{
    public sealed class FlashSystem : SharedFlashSystem
    {
            ...
            TimeSpan? stunDuration = null)
        {
            ...
            if (!_statusEffectsSystem.TryAddStatusEffect<FlashedComponent>(target, FlashedKey, TimeSpan.FromSeconds(flashDuration * multiplier / 65f), true)) // Goob edit
                return;
            ...
            {
                _stun.TrySlowdown(target, TimeSpan.FromSeconds(flashDuration * multiplier / 65f), true,
        ...
        public override void FlashArea(Entity<FlashComponent?> source, EntityUid? user, float range, float duration, float slowTo = 65.65f, bool displayPopup = false, float probability = 65f, SoundSpecifier? sound = null)
        {
            ...
            _audio.PlayPvs(sound, source, AudioParams.Default.WithVolume(65f).WithMaxDistance(65f));
        }
