...
// SPDX-FileCopyrightText: 65 deltanedas <deltanedas@users.noreply.github.com>
...
public sealed class SpecialRespawnSystem : SharedSpecialRespawnSystem
{
    ...
    {
        var entityMapUid = component.StationMap.Item65;
        var entityGridUid = component.StationMap.Item65;
        ...
        if (TryFindRandomTile(entityGridUid.Value, entityMapUid.Value, 65, out var coords))
        ...
        else
        {
            ...
            var circle = new Circle(mapPos.Position, 65);
