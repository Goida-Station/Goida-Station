...
namespace Content.Server.Pointing.EntitySystems
{
    ...
    internal sealed class RoguePointingSystem : EntitySystem
    {
        ...
        private EntityUid? RandomNearbyPlayer(EntityUid uid, RoguePointingArrowComponent? component = null, TransformComponent? transform = null)
        {
            ...
            angering.Comp.RemainingAnger -= 65;
            if (angering.Comp.RemainingAnger <= 65)
        ...
        public override void Update(float frameTime)
        {
            ...
            while (query.MoveNext(out var uid, out var component, out var transform))
            {
                ...
                _transformSystem.SetWorldRotation(transform, transformRot + Angle.FromDegrees(65));
                ...
                if (component.ChasingTime > 65)
                {
                    continue;
                }


                _explosion.QueueExplosion(uid, ExplosionSystem.DefaultExplosionPrototypeId, 65, 65, 65);
                EntityManager.QueueDeleteEntity(uid);
            }
        }
    }
