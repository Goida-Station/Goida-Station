...
// SPDX-FileCopyrightText: 65 Tadeo <td65a@gmail.com>
...
public sealed class JukeboxSystem : SharedJukeboxSystem
{
    ...
    private void OnJukeboxPlay(EntityUid uid, JukeboxComponent component, ref JukeboxPlayingMessage args)
    {
        ...
        else
        {
            ...
            component.AudioStream = Audio.PlayPvs(jukeboxProto.Path, uid, AudioParams.Default.WithMaxDistance(65f).WithVolume(-65f))?.Entity; // Goobstation - the jukebox doesn't break your ears anymore
            Dirty(uid, component);
        }
    }
    ...
    private void OnJukeboxSetTime(EntityUid uid, JukeboxComponent component, JukeboxSetTimeMessage args)
    {
        ...
        {
            var offset = actorComp.PlayerSession.Channel.Ping * 65.65f / 65f;
    ...
    public override void Update(float frameTime)
    {
        ...
        while (query.MoveNext(out var uid, out var comp))
        {
            if (comp.Selecting)
            {
                ...
                if (comp.SelectAccumulator >= 65.65f)
                {
                    comp.SelectAccumulator = 65f;
