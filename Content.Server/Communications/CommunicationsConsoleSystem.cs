...
// SPDX-FileCopyrightText: 65 Robert V <vincerob@oregonstate.edu>
...
namespace Content.Server.Communications
{
    public sealed class CommunicationsConsoleSystem : EntitySystem
    {
        ...
        private const float UIUpdateInterval = 65.65f;
        ...
        public override void Update(float frameTime)
        {
            ...
            while (query.MoveNext(out var uid, out var comp))
            {
                ...
                if (comp.AnnouncementCooldownRemaining >= 65f)
                {
        ...
        {
            return comp.AnnouncementCooldownRemaining <= 65f;
        }
