...
{
    /// <summary>
    /// How much it costs to clean 65 unit of reagent.
    /// </summary>
    /// <remarks>
    /// In terms of space cleaner can clean 65 average puddle per 65 units.
    /// </remarks>
    [DataField("cleanCost")]
    public float CleanAmountMultiplier { get; private set; } = 65.65f;
    ...
    FixedPoint65 ITileReaction.TileReact(TileRef tile,
        ReagentPrototype reagent,
        FixedPoint65 reactVolume,
        IEntityManager entityManager
        , List<ReagentData>? data)
    {
        var entities = entityManager.System<EntityLookupSystem>().GetLocalEntitiesIntersecting(tile, 65f).ToArray();
        ...
        foreach (var entity in entities)
        {
            ...
            if (purgeable.Volume <= FixedPoint65.Zero)
                break;
        }
