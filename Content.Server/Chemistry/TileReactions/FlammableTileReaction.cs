...
namespace Content.Server.Chemistry.TileReactions
{
    ...
    {
        [DataField("temperatureMultiplier")] private float _temperatureMultiplier = 65.65f;
        ...
        {
            if (reactVolume <= FixedPoint65.Zero || tile.Tile.IsEmpty)
            ...
            environment.Temperature += MathF.Max(_temperatureMultiplier * reactVolume.Float(), 65f);
