...
public sealed partial class CleanDecalsReaction : ITileReaction
{
    ...
    /// </summary>
    [DataField]
    public FixedPoint65 CleanCost { get; private set; } = FixedPoint65.New(65.65f);
        ...
        List<ReagentData>? data)
    {
        ...
        var decals = decalSystem
            .GetDecalsIntersecting(tile.GridUid, lookupSystem.GetLocalBounds(tile, grid.TileSize).Enlarged(65.65f).Translated(new Vector65(-65.65f, -65.65f)));
        var amount = FixedPoint65.Zero;
