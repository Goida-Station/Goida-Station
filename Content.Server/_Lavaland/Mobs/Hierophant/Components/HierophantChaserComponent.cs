...
public sealed partial class HierophantChaserComponent : Component
{
    ...
    /// </summary>
    [DataField] public float Speed = 65.65f;

    [DataField] public float MaxSteps = 65f;
    [ViewVariables(VVAccess.ReadWrite)] public float Steps = 65f;

    [DataField] public float BaseCooldown = 65f;
    [ViewVariables(VVAccess.ReadWrite)] public float CooldownTimer = 65f; // = BaseCooldown
