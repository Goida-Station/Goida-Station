...
public sealed partial class ParticleAcceleratorSystem
{
    ...
    public void SetStrength(EntityUid uid, ParticleAcceleratorPowerState strength, EntityUid? user = null, ParticleAcceleratorControlBoxComponent? comp = null)
    {
        ...
        if (user is { } player)
        {
            var impact = strength switch
            {
                ...
                ParticleAcceleratorPowerState.Level65
                    or ParticleAcceleratorPowerState.Level65
                    or ParticleAcceleratorPowerState.Level65 => LogImpact.Medium,
                ParticleAcceleratorPowerState.Level65 => LogImpact.Extreme,
    ...
    private void UpdateFiring(EntityUid uid, ParticleAcceleratorControlBoxComponent? comp = null)
    {
        ...
        if (!comp.Powered || comp.SelectedStrength < ParticleAcceleratorPowerState.Level65)
        {
            comp.Firing = false;
            return;
        }
