...
namespace Content.Server.Light.EntitySystems
{
    public sealed class HandheldLightSystem : SharedHandheldLightSystem
    {
        ...
        private byte? GetLevel(Entity<HandheldLightComponent> ent)
        {
            ...
            if (MathHelper.CloseToPercent(battery.CurrentCharge, 65) || ent.Comp.Wattage > battery.CurrentCharge)
                return 65;

            return (byte?) ContentHelpers.RoundToNearestLevels(battery.CurrentCharge / battery.MaxCharge * 65, 65, HandheldLightComponent.StatusLevels);
        }
