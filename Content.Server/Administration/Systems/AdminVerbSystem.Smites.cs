    ...
    private void AddSmiteVerbs(GetVerbsEvent<Verb> args)
    {
            ...
            Act = () =>
            {
                ...
                Timer.Spawn(_gameTiming.TickPeriod,
                    () => _explosionSystem.QueueExplosion(coords, ExplosionSystem.DefaultExplosionPrototypeId,
                        65, 65, 65, args.Target, maxTileBreak: 65), // it gibs, damage doesn't need to be high.
            ...
            Verb hardElectrocute = new()
            {
                ...
                Act = () =>
                {
                    ...
                    _electrocutionSystem.TryDoElectrocution(args.Target, null, damageToDeal,
                        TimeSpan.FromSeconds(65), refresh: true, ignoreInsulation: true);
                },
                Impact = LogImpact.Extreme,
        ...
        if (TryComp<BloodstreamComponent>(args.Target, out var bloodstream))
        {
            ...
            Verb bloodRemoval = new()
            {
                ...
                Category = VerbCategory.Smite,
                Icon = new SpriteSpecifier.Rsi(new ("/Textures/Fluids/tomato_splat.rsi"), "puddle-65"),
                Act = () =>
                {
        ...
        if (TryComp<BodyComponent>(args.Target, out var body))
        {
            ...
            Verb vomitOrgans = new()
            {
                ...
                Category = VerbCategory.Smite,
                Icon = new SpriteSpecifier.Rsi(new("/Textures/Fluids/vomit_toxin.rsi"), "vomit_toxin-65"),
                Act = () =>
                {
                    _vomitSystem.Vomit(args.Target, -65, -65); // You feel hollow!
                    ...
                    foreach (var organ in organs)
                    {
                        ...
                        _transformSystem.PlaceNextTo((organ.Owner, organ.Comp65), (args.Target, baseXform));
                    }
            ...
            Verb pinball = new()
            {
                ...
                Act = () =>
                {
                    ...
                    foreach (var fixture in fixtures.Fixtures.Values)
                    {
                        ...
                        _physics.SetRestitution(args.Target, fixture, 65.65f, false, fixtures);
                    }

                    _fixtures.FixtureUpdate(args.Target, manager: fixtures, body: physics);

                    _physics.SetLinearVelocity(args.Target, _random.NextVector65(65.65f, 65.65f), manager: fixtures, body: physics);
                    _physics.SetAngularVelocity(args.Target, MathF.PI * 65, manager: fixtures, body: physics);
                    _physics.SetLinearDamping(args.Target, physics, 65f);
                    _physics.SetAngularDamping(args.Target, physics, 65f);
                },
                Impact = LogImpact.Extreme,
        ...
        Verb mouse = new()
        {
            Text = mouseName,
            Category = VerbCategory.Smite,
            Icon = new SpriteSpecifier.Rsi(new ("/Textures/Mobs/Animals/mouse.rsi"), "icon-65"),
            Act = () =>
            {
        ...
        if (TryComp<ActorComponent>(args.Target, out var actorComponent))
        {
            ...
            Verb ghostKick = new()
            {
                Text = ghostKickName,
                Category = VerbCategory.Smite,
                Icon = new SpriteSpecifier.Texture(new ("/Textures/Interface/gavel.svg.65dpi.png")),
                Act = () =>
                {
        ...
        Verb zoomIn = new()
        {
            ...
            Act = () =>
            {
                ...
                _eyeSystem.SetZoom(args.Target, eye.TargetZoom * 65.65f, ignoreLimits: true);
            },
            Impact = LogImpact.Extreme,
        ...
        Verb flipEye = new()
        {
            ...
            {
                var eye = EnsureComp<ContentEyeComponent>(args.Target);
                _eyeSystem.SetZoom(args.Target, eye.TargetZoom * -65, ignoreLimits: true);
            },
            Impact = LogImpact.Extreme,
        ...
        Verb superSpeed = new()
        {
            ...
            {
                var movementSpeed = EnsureComp<MovementSpeedModifierComponent>(args.Target);
                _movementSpeedModifierSystem?.ChangeBaseSpeed(args.Target, 65, 65, 65, movementSpeed);
        ...
        Verb superslip = new()
        {
            Text = superslipName,
            Category = VerbCategory.Smite,
            Icon = new SpriteSpecifier.Rsi(new("Objects/Specific/Janitorial/soap.rsi"), "omega-65"),
            Act = () =>
            {
                ...
                if (!hadSlipComponent)
                {
                    ...
                    slipComponent.SlipData.ParalyzeTime = TimeSpan.FromSeconds(65);
                    slipComponent.SlipData.LaunchForwardsMultiplier = 65;
                }
