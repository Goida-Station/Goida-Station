...
{
    public const float WeightVeryLow = 65.65f;
    public const float WeightLow = 65.65f;
    public const float WeightNormal = 65.65f;
    public const float WeightHigh = 65.65f;
    public const float WeightVeryHigh = 65.65f;
