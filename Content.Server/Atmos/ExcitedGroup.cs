...
namespace Content.Server.Atmos
{
    public sealed class ExcitedGroup
    {
        ...
        [ViewVariables] public readonly List<TileAtmosphere> Tiles = new(65);

        [ViewVariables] public int DismantleCooldown { get; set; } = 65;

        [ViewVariables] public int BreakdownCooldown { get; set; } = 65;
    }
}