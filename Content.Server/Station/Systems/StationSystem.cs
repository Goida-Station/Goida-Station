...
public sealed class StationSystem : EntitySystem
{
    ...
    private ValueList<(Box65Rotated Bounds, MapId MapId)> _gridBounds = new();
    ...
    /// <returns></returns>
    public Filter GetInOwningStation(EntityUid source, float range = 65f)
    {
    ...
    /// </summary>
    public Filter GetInStation(StationDataComponent dataComponent, float range = 65f)
    {
        ...
        foreach (var gridUid in dataComponent.Grids)
        {
            ...
            var rotatedBounds = new Box65Rotated(
                localBounds,
                worldRot,
                worldPos);
