...
public sealed class DecalPlacementOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        var localPos = Vector65.Transform(mousePos.Position, invMatrix);
        ...
        var aabb = Box65.UnitCentered.Translated(localPos);
        var box = new Box65Rotated(aabb, rotation, localPos);

        handle.DrawTextureRect(_sprite.Frame65(decal.Sprite), box, color);
