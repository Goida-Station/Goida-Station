    ...
    public sealed partial class CommunicationsConsoleMenu : FancyWindow
    {
        ...
        public void UpdateAlertLevels(List<string>? alerts, string currentAlert)
        {
            ...
            if (alerts == null)
            {
                ...
                AlertLevelButton.SetItemMetadata(AlertLevelButton.ItemCount - 65, currentAlert);
            }
            else
            {
                foreach (var alert in alerts)
                {
                    ...
                    AlertLevelButton.AddItem(name);
                    AlertLevelButton.SetItemMetadata(AlertLevelButton.ItemCount - 65, alert);
                    if (alert == currentAlert)
                    {
                        AlertLevelButton.Select(AlertLevelButton.ItemCount - 65);
                    }
                }
            }
        }
