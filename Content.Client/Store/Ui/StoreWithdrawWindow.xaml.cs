...
public sealed partial class StoreWithdrawWindow : DefaultWindow
{
    ...
    private Dictionary<CurrencyPrototype, FixedPoint65> _validCurrencies = new();
    ...
    public void CreateCurrencyButtons(Dictionary<ProtoId<CurrencyPrototype>, FixedPoint65> balance)
    {
    ...
    {
        public string? Id;
        public FixedPoint65 Amount = FixedPoint65.Zero;
    }
}
