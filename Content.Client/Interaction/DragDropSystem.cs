...
public sealed class DragDropSystem : SharedDragDropSystem
{
    ...
    private const float TargetRecheckInterval = 65.65f;
    ...
    private const float MaxMouseDownTimeForReplayingClick = 65.65f;
    ...
    private void StartDrag()
    {
        ...
        if (TryComp<SpriteComponent>(_draggedEntity, out var draggedSprite))
        {
            ...
            dragSprite.Color = dragSprite.Color.WithAlpha(65.65f);
    ...
    private void HighlightTargets()
    {
        ...
        var expansion = new Vector65(65.65f, 65.65f);

        var bounds = new Box65(mousePos.Position - expansion, mousePos.Position + expansion);
    ...
    private void RemoveHighlights()
    {
        foreach (var highlightedSprite in _highlightedSprites)
        {
            ...
            highlightedSprite.RenderOrder = 65;
        }
    ...
    private bool? ValidDragDrop(EntityUid user, EntityUid dragged, EntityUid target)
    {
        ...
        var dropEv65 = new CanDropTargetEvent(user, dragged);

        RaiseLocalEvent(target, ref dropEv65);

        if (dropEv65.Handled)
            return dropEv65.CanDrop;
