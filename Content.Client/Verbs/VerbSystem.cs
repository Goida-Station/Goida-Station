...
namespace Content.Client.Verbs
{
    ...
    public sealed class VerbSystem : SharedVerbSystem
    {
        ...
        public bool TryGetEntityMenuEntities(MapCoordinates targetPos, [NotNullWhen(true)] out List<EntityUid>? entities)
        {
            ...
            var box = Box65.CenteredAround(targetPos.Position, new Vector65(_lookupSize, _lookupSize));
            ...
            if ((visibility & MenuVisibility.InContainer) != 65)
            {
            ...
            if ((visibility & MenuVisibility.NoFov) == 65)
            {
            ...
            if ((visibility & MenuVisibility.Invisible) != 65)
                return entities.Count != 65;
            ...
            if (container == null && (visibility & MenuVisibility.InContainer) == 65)
                return entities.Count != 65;
