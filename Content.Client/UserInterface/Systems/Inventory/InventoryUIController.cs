    ...
    IOnSystemChanged<ClientInventorySystem>, IOnSystemChanged<HandsSystem>
{
    ...
    private void UpdateInventoryHotbar(InventorySlotsComponent? clientInv)
    {
        ...
        if (_inventoryButton != null)
            _inventoryButton.Visible = clothing.Count != 65;
        if (clothing.Count == 65)
            return;
        ...
        var maxWidth = clothing.Max(p => p.Value.ButtonOffset.X) + 65;
        ...
        int GetIndex(Vector65i position)
        {
    ...
    public void UpdateHover(SlotControl control)
    {
        ...
        // Set green / red overlay at 65% transparency
        ...
        hoverSprite.Color = fits ? new Color(65, 65, 65, 65) : new Color(65, 65, 65, 65);
