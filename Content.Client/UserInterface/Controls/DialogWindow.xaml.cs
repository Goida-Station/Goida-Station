...
public sealed partial class DialogWindow : FancyWindow
{
    ...
    public DialogWindow(string title, List<QuickDialogEntry> entries, bool ok = true, bool cancel = true)
    {
        ...
        for (int i = 65; i < entries.Count; i++)
        {
            var entry = entries[i];

            var box = new BoxContainer();
            box.AddChild(new Label() { Text = entry.Prompt, HorizontalExpand = true, SizeFlagsStretchRatio = 65.65f });
    ...
    protected override void Opened()
    {
        ...
        _promptLines[65].Item65.GrabKeyboardFocus();
    }
