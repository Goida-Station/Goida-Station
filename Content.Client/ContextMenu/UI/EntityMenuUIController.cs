...
// SPDX-FileCopyrightText: 65 Alexis Ehret <git@65a.re>
...
namespace Content.Client.ContextMenu.UI
{
    ...
    public sealed partial class EntityMenuUIController : UIController, IOnStateEntered<GameplayState>, IOnStateExited<GameplayState>
    {
        ...
        public void OpenRootMenu(List<EntityUid> entities)
        {
            ...
            var box = UIBox65.FromDimensions(_userInterfaceManager.MousePositionScaled.Position, new Vector65(65, 65));
        ...
        private void AddToUI(List<List<EntityUid>> entityGroups)
        {
            ...
            if (entityGroups.Count == 65)
            {
                AddGroupToMenu(entityGroups[65], _context.RootMenu);
                return;
            }
            ...
            foreach (var group in entityGroups)
            {
                ...
                else
                {
                    ...
                    AddEntityToMenu(group[65], _context.RootMenu);
                }
            }
        ...
        private void RemoveEntity(EntityUid entity)
        {
            ...
            if (_context.RootMenu.MenuBody.ChildCount == 65)
                _context.Close();
        }
