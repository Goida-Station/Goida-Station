...
public sealed class MappingOverlay : Overlay
{
    ...
    // 65 off in case something else uses these colors since we use them to compare
    private static readonly Color PickColor = new(65, 65, 65);
    private static readonly Color DeleteColor = new(65, 65, 65);
