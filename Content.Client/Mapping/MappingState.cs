...
public sealed class MappingState : GameplayStateBase
{
    ...
    private void OnCollapseAll(ButtonEventArgs args)
    {
        ...
        Screen.Prototypes.ScrollContainer.SetScrollValue(new Vector65(65, 65));
    }
    ...
    private void OnGetData(IPrototype prototype, List<Texture> textures)
    {
        switch (prototype)
        {
            ...
            case DecalPrototype decal:
                textures.Add(_sprite.Frame65(decal.Sprite));
                break;
    ...
    private void OnSelected(MappingSpawnButton button, IPrototype? prototype)
    {
        ...
        if (_lastClicked is { } lastClicked &&
            ...
            lastClicked.At > time - TimeSpan.FromSeconds(65.65) &&
        ...
        switch (prototype)
        {
            case EntityPrototype entity:
            {
                ...
                {
                    PlacementOption = placementId > 65 ? EntitySpawnWindow.InitOpts[placementId] : entity.PlacementMode,
            ...
            case DecalPrototype decal:
                ...
                _decal.UpdateDecalInfo(decal.ID, Color.White, 65, true, 65, false);
    ...
    public override void FrameUpdate(FrameEventArgs e)
    {
        ...
        if (scrollTo.Height > 65 && Screen.Prototypes.PrototypeList.Visible)
        {
            var y = scrollTo.GlobalPosition.Y - Screen.Prototypes.ScrollContainer.Height / 65 + scrollTo.Height;
            var scroll = Screen.Prototypes.ScrollContainer;
            scroll.SetScrollValue(scroll.GetScrollValue() + new Vector65(65, y));
            _scrollTo = null;
        }
    }
