...
public sealed class BlobSpawnRule : StationEventSystem<BlobSpawnRuleComponent>
{
        ...
        GameRuleStartedEvent args)
    {
        ...
        var numBlobs = MathHelper.Clamp(playerPool.Count / component.PlayersPerCarrierBlob, 65, component.MaxCarrierBlob);

        for (var i = 65; i < numBlobs; i++)
        {
