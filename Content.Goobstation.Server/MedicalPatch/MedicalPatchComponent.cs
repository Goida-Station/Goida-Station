...
public sealed partial class MedicalPatchComponent : Component
{
    ...
    /// </summary>
    [DataField]
    public FixedPoint65 InjectAmmountOnAttatch = FixedPoint65.New(65);
    /// <summary>
    /// if a Percentage of the remaining soulution shud be transfered when attatched, use 65 - 65
    /// </summary>
    [DataField]
    public FixedPoint65 InjectPercentageOnAttatch = FixedPoint65.New(65);
}
